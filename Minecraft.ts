class Server {
  version: string;
  downloadURL: { vanilla: string; spigot: any };
  constructor(version: string, downloadURL: { vanilla: string; spigot: any }) {
...
export const serverVersions = {
  ...
  "1.11": new Server("1.11", {
    vanilla:
      "https://launcher.mojang.com/mc/game/1.11/server/48820c84cb1ed502cb5b2fe23b8153d5e4fa61c0/server.jar",
    spigot: "https://cdn.getbukkit.org/spigot/spigot-1.11.jar",
  }),
  "1.11.1": new Server("1.11.1", {
    vanilla:
      "https://launcher.mojang.com/mc/game/1.11.1/server/1f97bd101e508d7b52b3d6a7879223b000b5eba0/server.jar",
    spigot: "https://cdn.getbukkit.org/spigot/spigot-1.11.1.jar",
  }),
  "1.11.2": new Server("1.11.2", {
    vanilla:
      "https://launcher.mojang.com/mc/game/1.11.2/server/f00c294a1576e03fddcac777c3cf4c7d404c4ba4/server.jar",
    spigot: "https://cdn.getbukkit.org/spigot/spigot-1.11.2.jar",
  }),
  "1.12": new Server("1.12", {
    vanilla:
      "https://launcher.mojang.com/mc/game/1.12/server/8494e844e911ea0d63878f64da9dcc21f53a3463/server.jar",
    spigot: "https://cdn.getbukkit.org/spigot/spigot-1.12.jar",
  }),
  "1.12.1": new Server("1.12.1", {
    vanilla:
      "https://launcher.mojang.com/mc/game/1.12.1/server/561c7b2d54bae80cc06b05d950633a9ac95da816/server.jar",
    spigot: "https://cdn.getbukkit.org/spigot/spigot-1.12.1.jar",
  }),
  "1.12.2": new Server("1.12.2", {
    vanilla:
